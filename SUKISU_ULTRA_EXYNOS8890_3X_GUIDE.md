...
chmod +x integrate_sukisu_ultra.sh
ENABLE_SUSFS=0 SKIP_BUILD=1 bash ./integrate_sukisu_ultra.sh .config
# Optional risky path with SUSFS:
# ENABLE_SUSFS=1 SKIP_BUILD=1 bash ./integrate_sukisu_ultra.sh .config
```
