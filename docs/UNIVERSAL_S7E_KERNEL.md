...
- O runtime tune agora tenta manter o teto do big core em `3016000` sempre (`LOCK_BIG_MAX_TO_TARGET=1`), só caindo para o topo disponível quando esse bin realmente não existe no kernel/dispositivo.
