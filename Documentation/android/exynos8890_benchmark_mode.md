...
File: `drivers/gpu/arm/t8xx/r30p0/platform/exynos/gpu_dvfs_governor.c`

Implemented:
- `gpu_benchmark_mode` module parameter
- when enabled, `gpu_dvfs_decide_next_freq()` pins to `gpu_max_clock_limit`
- IPA callback still receives the locked freq request
